...
fn create_config(path: &str, env: Vec<(&'static str, &'static str)>) -> Config {
    ...
    #[cfg(feature = "binary")]
    hash.insert("SYSTEM_DEPS_NO_BINARY", "".to_string());
...
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTDATA_NO_BINARY
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTLIB_LINK
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTLIB_NO_BINARY
...
cargo:rerun-if-env-changed=SYSTEM_DEPS_TEST_LIB_NO_BINARY
"#,
    );
}
...
fn static_one_lib() {
    ...
    assert!(testlib.statik == cfg!(feature = "binary"));
...
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTSTATICLIB_NO_BINARY
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTDATA_LIB
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTDATA_LIB_FRAMEWORK
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTDATA_SEARCH_NATIVE
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTDATA_SEARCH_FRAMEWORK
...
cargo:rerun-if-env-changed=SYSTEM_DEPS_TESTLIBWITHRPATH_NO_BINARY
cargo:rerun-if-env-changed=SYSTEM_DEPS_LINK
"#,
    );
}
